...
import fun.bm.simpletpartm.configs.modules.TpHereConfig;
...
public class TpHereAcceptCommand extends AbstractCommand {
                    ...
                    .register(
                            CommandManager
                                    ...
                                    .executes(context -> {
                                        ...
                                        return executeTpHereAccept(context, from, into);
                                    })
                                    .then(
                                            CommandManager
    ...
    public static int executeTpHereAccept(CommandContext<ServerCommandSource> context, ServerPlayerEntity from, ServerPlayerEntity into) {
        ...
        if (!TpHereConfig.checkTpHere(from, into)) {
        ...
        Runnable task = () -> {
            if (TpaAcceptCommand.onlineCheck(from, into)) return;
